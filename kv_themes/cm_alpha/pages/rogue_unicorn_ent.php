    ...
    <div class="fadein-screen">
        <div class="container">
            <div class="row">
                ...
                <?php
                    logo_load(array (
                        "images" => array ("cmlandrus_logo_background.png","rogue_unicorn_ent_logo.png","coming_soon.png"),
                        "link_type" => "pages",
                        "link_dest" => "main.php",
                        "link_img" => "back_to_main_for_rue.png"));
                ?>
                </div>
        ...
        <div style="rogue-unicorn-ent-menu">
            <?php /* 
                kvcm_load_menu(array ( 
                        "tbl_name" => "back_button", 
